...
public class RSAUtils {
     ...
     * @throws Exception
     */
    public static Map<String, Object> genKeyPair(String pkey,String rkey) throws Exception {
    	...
    	if(StringUtils.isNotBlank(rkey)){
    		RSAPrivateKey privateKey = getPrivateKey(rkey);
    ...
    * @throws Exception
    */
    public static RSAPrivateKey getPrivateKey(String rkey) throws Exception {
    	byte[] buffer = Base64Utils.decode(rkey);    
